...
public abstract class AHFLineFollowingGameController<T1, T2, T3, T4, T5> : MonoBehaviour
  ...
  where T5 : IBrain
{
  ...
  //Center Line
  Line2D m_fitnessLine = new Line2D(new Vector2(0, 1), new Vector2(1, 0));
  Line2D m_healthLine = new Line2D(new Vector2(0, -1), new Vector2(1, 0));
  

	public Line2D FitnessLine { get { return m_fitnessLine;} }
  public Line2D HealthLine { get { return m_healthLine;} }
  

  public float m_time;

  [Range(1, 50)]
  public float m_time_scale = 50;
