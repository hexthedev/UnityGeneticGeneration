...
// 	//Global References
// 	LineFollowingNNGameController m_controller;

// 	//DNA, Brain and Traits
// 	MindBodyNNDNA<LineFollowingNNCreature> m_dna;
...
// 	public void Initialize(MindBodyNNDNA<LineFollowingNNCreature> p_dna, LineFollowingNNGameController p_controller, Line2D p_goalLine){
// 		m_is_initialized = true;
// 		m_dna = p_dna.Clone();

// 		MindBodyNN mindbody = p_dna.express(this);
...
// 	public static DInputFactory<LineFollowingNNCreature> closenessToLine = (LineFollowingNNCreature p_creature) => {
...
// 	public static DInputFactory<LineFollowingNNCreature> closenessToLineFromForwardCast = (LineFollowingNNCreature p_creature) => {
...
// 	public static DInputFactory<LineFollowingNNCreature> lineIsRight = (LineFollowingNNCreature p_creature) => {
// 		return () => { 			
// 			Vector3 creature_position = p_creature.gameObject.transform.position;
...
// 		public static DInputFactory<LineFollowingNNCreature> lineIsLeft = (LineFollowingNNCreature p_creature) => {
// 		return () => { 			
// 			Vector3 creature_position = p_creature.gameObject.transform.position;
// 			Vector2 projVector = Line2D.projection(creature_position, p_creature.m_goalLine)-Vector2Calc.fromVector3(creature_position);
// 			float direction = Mathf.Sign( Vector2Calc.getAngle(projVector, p_creature.m_forward ) );
...
// 	public static DOutputFactory<LineFollowingNNCreature> moveForward = (LineFollowingNNCreature p_creature) => {
...
// 	public static DOutputFactory<LineFollowingNNCreature> moveDont = (LineFollowingNNCreature p_creature) => {
// 		return (float p_value) => { 			
// 			p_creature.m_actions.add("Move", p_value, () => {});
// 		};
// 	};

// 	public static DOutputFactory<LineFollowingNNCreature> moveStop = (LineFollowingNNCreature p_creature) => {
// 		return (float p_value) => { 			
// 			p_creature.m_actions.add("Move", p_value, () => {p_creature.gameObject.GetComponent<Rigidbody2D>().velocity = Vector2.zero;});
// 		};
// 	};

// 	public static DOutputFactory<LineFollowingNNCreature> moveBackwards = (LineFollowingNNCreature p_creature) => {
// 		return (float p_value) => { 			
...
// 	public static DOutputFactory<LineFollowingNNCreature> rotateDont = (LineFollowingNNCreature p_creature) => {
// 		return (float p_value) => { 			
...
// 	public static DOutputFactory<LineFollowingNNCreature> rotateLeft = (LineFollowingNNCreature p_creature) => {
// 		return (float p_value) => { 			
// 			p_creature.m_actions.add("Rotate", p_value, () => { p_creature.transform.Rotate(0,0,-10);});
// 		};
// 	};

// 		public static DOutputFactory<LineFollowingNNCreature> rotateRight = (LineFollowingNNCreature p_creature) => {
// 		return (float p_value) => { 			
// 			p_creature.m_actions.add("Rotate", p_value, () => { p_creature.transform.Rotate(0,0,10);});
// 		};
// 	};
