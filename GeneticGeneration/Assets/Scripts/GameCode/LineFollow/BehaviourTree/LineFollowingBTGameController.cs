...
public class LineFollowingBTGameController : MonoBehaviour {

	public GameObject m_prefab;
	public DNABasedEvolutionManager<MindBodyBTDNA<LineFollowingBTCreature>> m_evolution;
	...
	void Start () {
		m_evolution = new DNABasedEvolutionManager<MindBodyBTDNA<LineFollowingBTCreature>>(
	...
	void spawn(){
		...
		LineFollowingBTCreature cre = obj.GetComponent<LineFollowingBTCreature>();		
		cre.Initialize(m_evolution.birth(), this, m_goalLine);
	}

	public void logDNA(MindBodyBTDNA<LineFollowingBTCreature> dna, float fitness){
