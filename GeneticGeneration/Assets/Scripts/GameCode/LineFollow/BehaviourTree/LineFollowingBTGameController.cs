...
// public class LineFollowingNNGameController : MonoBehaviour {

// 	public GameObject m_prefab;
// 	public DNABasedEvolutionManager<MindBodyNNDNA<LineFollowingNNCreature>> m_evolution;
...
// 	void Start () {
// 		m_evolution = new DNABasedEvolutionManager<MindBodyNNDNA<LineFollowingNNCreature>>(
...
// 		LineFollowingNNCreature cre = obj.GetComponent<LineFollowingNNCreature>();		
// 		cre.Initialize(m_evolution.birth(), this, m_goalLine);
// 	}

// 	public void logDNA(MindBodyNNDNA<LineFollowingNNCreature> dna, float fitness){
