...
public static class lineFollowCONFIG {
	...
	public static void loadScene(){
		...
		switch(AIkey){
			...
			break;
			case "NeuralNet":
				SceneManager.LoadScene( "LineFollowNNScene" );
			break;
		}
	}
	...
	public static string AIkey = "DecisionNet";

	public static string DataSuffix = "FollowLineHarshX0ExtraInput";
